...
<head>
  ...
  <style> 
      body {text-align:center;}
        ...
        .button1 {  display: inline-block;  border-radius: 4px;  background-color: lightblue;  border: none;  color: black;  text-align: center;  font-size: 16px;  padding: 20px;  width: 200px;  transition: all 0.5s;  cursor: pointer;  margin: 5px;}
        ...
        .button2 {  display: inline-block;  border-radius: 4px;  background-color: orange;  border: none;  color: black;  text-align: center;  font-size: 16px;  padding: 20px;  width: 200px;  transition: all 0.5s;  cursor: pointer;  margin: 5px;}
    ...
    <p>
        <h1>
            <div style="width: 300px; margin-left: auto; margin-right: auto;">
                ...
                <button class="button1" style="vertical-align:middle" onclick="window.location.href='flow.html'"><span><b>Tree process</b></span></button>
                <button class="button2" style="vertical-align:middle" onclick="window.location.href='add.html'"><span><b>More plants</b></span></button>
...
//------------------------------------------------Khay1
const char tray1Page[] PROGMEM = R"=====(
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
//------------------------------------------------Khay2
const char tray2Page[] PROGMEM = R"=====(
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
//------------------------------------------------Khay3
const char tray3Page[] PROGMEM = R"=====(
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
//------------------------------------------------Khay4
const char tray4Page[] PROGMEM = R"=====(
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
//-----------------------------------
  ...
  webServer.on("/dataTray2.html", []() {
    String s = tray2Page;
    webServer.send(200, "text/html", s);
  });
      webServer.on("/dataTray3.html", []() {
    String s = tray3Page;
    webServer.send(200, "text/html", s);
  });
  webServer.on("/dataTray4.html", []() {
    String s = tray4Page;
    webServer.send(200, "text/html", s);
  });
  webServer.begin();
